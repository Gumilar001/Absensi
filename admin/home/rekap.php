  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="../../assets/elements/bc_color.html" class="pc-link">
        ...
        <li class="pc-item">
          <a href="../elements/icon-tabler.html" class="pc-link">
            <span class="pc-micon"><i class="ti ti-fingerprint"></i></span>
            <span class="pc-mtext">Rekap Presensi</span>
          </a>
        </li>
  ...
  <ul class="list-unstyled">
    ...
    <li class="dropdown pc-h-item header-user-profile">
      <a
        ...
        aria-expanded="false"
      >
        <img src="../../assets/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar">
        <span>Angelia Charlotte</span>
      </a>
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            <div class="flex-shrink-0">
              <img src="../../assets/assets/images/user/avatar-2.jpg" alt="user-image" class="user-avtar wid-35">
            </div>
            <div class="flex-grow-1 ms-3">
              <h6 class="mb-1">Angelia Charlotte</h6>
              <span>Magang</span>
            </div>
    ...
    <div class="pc-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xl-11">
          <h5 class="mb-3">Status Absensi</h5>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover table-borderless mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td><a href="#" class="text-muted">Kantor Pusat</a></td>
                      <td>Adun</td>
                      
                      <td><span class="d-flex align-items-center gap-2"><i
                            class="fas fa-circle text-danger f-10 m-r-5"></i>Alpa</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>Maman</td>
                      <td><span class="d-flex align-items-center gap-2"><i
                            class="fas fa-circle text-warning f-10 m-r-5"></i>Cuti/Izin/Sakit</span>
                      </td>
                      <td class="text-end">Sakit</td>
                      <td> <button type="button" class="btn btn-primary">Details</button></td>
                      <td> <button type="button" class="btn btn-primary">edit</button></td>
                      <td><button type="button" class="btn btn-danger">delete</button> </td>
                    </tr>
                    <tr>
                      ...
                      <td>Asep</td>
                      <td><span class="d-flex align-items-center gap-2"><i
                            class="fas fa-circle text-success f-10 m-r-5"></i>Hadir</span></td>
                      <td class="text-end">Maintanance gudang Sindanglaya</td>
                      <td> <button type="button" class="btn btn-primary">Details</button></td>
                      <td> <button type="button" class="btn btn-primary">edit</button></td>
                      <td><button type="button" class="btn btn-danger">delete</button> </td>
                    </tr>
