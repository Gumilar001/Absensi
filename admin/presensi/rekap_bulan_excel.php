...
require('../../assets/assets/vendor/autoload.php');
...
$sheet->setCellValue('A1', 'REKAP ABSENSI BULANAN');
...
header('Content-Disposition: attachment;filename="Laporan Absen Bulanan.xls"');
