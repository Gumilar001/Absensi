          ...
          <div class="card">
            <div class="card-header pb-0">
              <ul class="nav nav-tabs profile-tabs" id="myTab" role="tablist">                
                ...
                <li class="nav-item">
                  <a class="nav-link" id="profile-tab-2" href="<?= base_url('workshop/presensi/rekap_presensi.php') ?>" role="tab"
                    aria-selected="true">
                    <i class="ti ti-clipboard-check me-2"></i>Rekap Presensi
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="profile-tab-3" href="<?= base_url('workshop/fitur_lainnya/edit.php') ?>" role="tab"
                    aria-selected="true">
                    <i class="ti ti-id me-2"></i>My Account
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="profile-tab-4" href="<?= base_url('workshop/fitur_lainnya/profile.php') ?>" role="tab"
                    aria-selected="true">
                    <i class="ti ti-user me-2"></i>Profile
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="profile-tab-5"href="<?= base_url('workshop/ketidakhadiran/ketidakhadiran.php') ?>" role="tab"
                    aria-selected="true">
                    ...
                    <div class="col-md-4">
                      <div class="card text-center h-100">
                        ...
                        <?php 
                          ...
                          <form method="POST" action="<?= base_url('workshop/presensi/presensi_masuk.php') ?>">
                            ...
                            <label for="" class="mb-2">Keterangan Lokasi Absensi</label><br>
                            <input class="form-contol" type="text" name="keterangan_lokasi" id="keterangan_lokasi"><br>
                    ...
                    <div class="col-md-4">
                      <div class="card text-center h-100">
                        ...
                        <div class="card-body">
                          ...
                          <form method="POST" action="<?= base_url('workshop/presensi/presensi_keluar.php') ?>">
