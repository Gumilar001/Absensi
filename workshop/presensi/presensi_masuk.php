...
if(empty($keterangan_lokasi)){
  $_SESSION['gagal'] = "Mohon Masukan Keterangan Lokasi Absensi Anda";
  header("Location: ../home/home.php");
  exit;
}
        ...
        <div class="col-md-6">
          <div class="card text-center">
            <div class="card-body" style="margin: auto;">
              ...
              <input type="hidden" id="keterangan_lokasi" value="<?= $keterangan_lokasi ?>">
  ...
  <script language="JavaScript">
        Webcam.set({
          ...
          document.getElementById('ambil_foto').addEventListener('click', function() {
            ...
            let keterangan_lokasi = document.getElementById('keterangan_lokasi').value;
